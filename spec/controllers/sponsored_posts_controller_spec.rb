...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let(:my_sponsored_post) { my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_sponsored_post_price) }
  ...
  describe 'POST create' do
    it 'increases the number of SponsoredPost by 1' do
      expect{post :create, topic_id: my_topic.id,
                  sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_sponsored_post_price}}
    ...
    it 'associates the new sponsored_post with my_topic' do
      post :create, topic_id: my_topic.id,
           sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_sponsored_post_price}
      expect(assigns(:sponsored_post).topic_id).to eq my_topic.id
    end
  ...
  describe 'PUT update' do
    it 'updates sponsored_post with expected attributes' do
      ...
      new_price = RandomData.random_sponsored_post_price
